...
/* ---- /1Gfey7wVXXg1rxk751TBTxLJwhddDNfcdp/js/lib/00-jquery.min.js ---- */
...
/* ---- /1Gfey7wVXXg1rxk751TBTxLJwhddDNfcdp/js/lib/ZeroFrame.coffee ---- */
...
/* ---- /1Gfey7wVXXg1rxk751TBTxLJwhddDNfcdp/js/lib/identicon.js ---- */
...
/* ---- /1Gfey7wVXXg1rxk751TBTxLJwhddDNfcdp/js/lib/jquery.csslater.coffee ---- */
...
/* ---- /1Gfey7wVXXg1rxk751TBTxLJwhddDNfcdp/js/lib/pnglib.js ---- */
...
/* ---- /1Gfey7wVXXg1rxk751TBTxLJwhddDNfcdp/js/ZeroBoard.coffee ---- */
...
(function() {
  ...
  ZeroBoard = (function(superClass) {
    extend(ZeroBoard, superClass);

    function ZeroBoard() {
      this.updateSite = bind(this.updateSite, this);
      this.loadAvatarsWorker = bind(this.loadAvatarsWorker, this);
      this.submittedMessage = bind(this.submittedMessage, this);
      this.onOpenWebsocket = bind(this.onOpenWebsocket, this);
    ...
    ZeroBoard.prototype.submitMessage = function() {
      ...
      if (body) {
        ...
        return $.post("https://zeroid.qc.to/ZeroBoard/add.php", {
          "body": body,
          "auth_key": auth_key,
          "hash": hash
    ...
    ZeroBoard.prototype.loadAvatarsWorker = function() {
      var hash, i, imagedata, j, new_styles;
      new_styles = "";
      for (i = j = 1; j <= 5; i = ++j) {
    ...
    ZeroBoard.prototype.loadMessages = function(cleanup) {
      ...
      this.cmd("fileGet", "messages.json", (function(_this) {
        return function(res) {
          var elem, elem_messages, empty, height, j, k, key, len, len1, message, messages, ref, ref1, s, template;
    ...
    ZeroBoard.prototype.actionSetSiteInfo = function(message) {
      ...
      if (((ref = message.params.event) != null ? ref["0"] : void 0) === "file_done" && ((ref1 = message.params.event) != null ? ref1["1"] : void 0) === "messages.json") {
